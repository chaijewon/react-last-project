...
function Footer(){
    return (
        ...
        <div id="copyright" className="hoc clear">
            <p className="fl_left">Copyright &copy; 2023-03-23 - 강남 쌍용 교육센터 - <a href="#">홍길동</a></p>
            <p className="fl_right">Product by <a href="https://github.com/chaijewon">GIT Address</a></p>
        </div>
        </div>
        </Fragment>
    )
